...
public class ModBlocks {
    ...
    public static final Block replacer = new BacteriaBlock(settings.breakInstantly().build());
    public static final Block replacerStarter = new ReplacerStarter(settings.build());

    public static final Block destroyer = new BacteriaBlock(settings.breakInstantly().build());
